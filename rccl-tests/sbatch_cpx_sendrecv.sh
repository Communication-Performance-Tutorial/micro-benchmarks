...
#SBATCH --output=/shared/prerelease/home/amd_int/slockhar/CommTutorial/micro-benchmarks/rccl-tests/cpx_sendrecv_%j.log
...
echo "=== CPX sendrecv: INTER_CCD + INTER_SOCKET ==="
